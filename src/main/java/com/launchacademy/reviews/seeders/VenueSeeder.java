...
public class VenueSeeder {
  ...
  public void run(String... args) throws Exception {
    ...
    if (venueService.count() <= 0){
      ...
      venue3.setImgUrl("https://cdn.wedding-spot.com/__sized__/images/venues/3956/Royale-Boston-MA-99fe4157-686d-41a1-a5e4-1fcf173da8e8-97450e389c42885476f1fbe9bc5bca5a.jpg");
      ...
      venue4.setDescription("This gastropub & music venue features New American fare and live acts, with an open kitchen & patio..");
      venue4.setImgUrl("https://64.media.tumblr.com/6ddda14544cb4e2bfa587357fccdaa82/4a2265bbab98e629-b5/s400x600/7056fcf7a1b82a90b26e99c8e79bdcdd1fd7dc04.jpg");
      ...
      venue5.setDescription("3S is committed to presenting a wide range of music, with a focus on adventurous, underrepresented, and unconventional acts. Our aim is to showcase some of the best national and international talent, and shine the spotlight on some of the best talent in the region.");
      venue5.setImgUrl("https://s3.amazonaws.com/media.wbur.org/wordpress/18/files/2015/09/pic3SDavidJMurrayCleareyephotocom-540x360.jpg");
      ...
      venue6.setDescription("The Great American Music Hall is a concert hall in San Francisco, California. It is located on O'Farrell Street in the Tenderloin neighborhood on the same block as the Mitchell Brothers O'Farrell Theatre.");
      venue6.setImgUrl("https://upload.wikimedia.org/wikipedia/commons/6/6a/Great_American_Music_Hall_%28April_1976%29.jpg");
      ...
      venue7.setDescription("The Hampton Beach Casino Ballroom is a seasonal live music and comedy venue located on the boardwalk of Hampton Beach, New Hampshire, United States. The venue is open from April to November, and within those eight months schedules upwards of 70 shows.");
      venue7.setImgUrl("https://www.gannett-cdn.com/presto/2020/11/23/NPOH/d443c490-6c73-4e11-9342-5ad624543801-18April-HB-Casino-COVIDsign.jpg?crop=2229,1672,x145,y0&quality=50&width=640");
      ...
      venue8.setDescription("This landmark venue, designed as an opera house in 1892, hosts concerts by well-known musical acts.");
      ...
      venue9.setDescription("The Wang Theatre is a theatre in Boston. It originally opened in 1925 as the Metropolitan Theatre and was later renamed the Music Hall. It was designed by Clarence Blackall and is located at 252–272 Tremont Street in the Boston Theatre District. The theatre is operated as part of the Boch Center.");
