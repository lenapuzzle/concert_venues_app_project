...
public class ReviewSeeder {
  ...
  public void run(String... args) throws Exception {
    if (reviewService.count() <= 0) {
      ...
      review5.setText(
          "Last week was my second time at Thalia Hall and I'm glad Chicago has a venue like this.\n"
              + "\n"
      ...
      review9
          .setText(" This is a decent concert venue, if there's an act you really want to see.\n "
